    ...
    <div className="min-h-screen relative">
      ...
      <nav className="fixed top-0 left-1/2 -translate-x-1/2 z-50 flex items-center justify-between px-4 py-2 bg-white rounded-lg mt-4 mx-auto max-w-6xl w-[95%]">
        ...
        <div className="hidden lg:flex items-center gap-6">
          <Button variant="ghost" className="text-[#6C757D]">
          ...
          <Button
            variant="secondary"
            className="bg-[#6C63AC] text-white hover:bg-[#5c54a0] rounded-full"
          >
            Transparencia
          </Button>
          <Link to={"/admin"}>
            <Button
              variant="default"
              className="bg-ttred hover:bg-[#d13844] rounded-full"
            >
      ...
      <div className="fixed top-16 left-1/2 -translate-x-1/2 z-40 flex items-center justify-center px-4 py-2 bg-ttred text-white rounded-lg mt-4 mx-auto max-w-6xl w-[95%]">
        <p className="text-xl sm:text-2xl font-bold uppercase">
          cómputo $4.001.431.592
        </p>
      </div>
      {/* Main Content */}
      <main className="relative z-10 pt-52 px-4">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <p className="text-lg md:text-xl text-white mb-8 max-w-4xl mx-auto">
            Con tu donación, más de 32 mil niños, niñas y jóvenes podrán seguir
            avanzando en sus procesos de rehabilitación, sin costo alguno, en
            nuestros 14 institutos del país. Cada aporte cuenta y hace posible
            un futuro con más inclusión y esperanza para miles de familias.
          </p>
          <Button
            size="lg"
            className="bg-[#E84855] hover:bg-[#d13844] text-xl px-8"
          >
            HAZ TU APORTE AQUÍ
          </Button>
        </div>
